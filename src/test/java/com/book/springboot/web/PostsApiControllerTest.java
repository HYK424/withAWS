...
public class PostsApiControllerTest {
    ...
    @Test
    @WithMockUser(roles="USER") /*인증된 가짜 사용자를 만들어 사용한다. roles에 권한을 추가할 수있다->해당 어노테이션은 ROLE_USER권하을가진
사용자가 API를 요청하는것과 동일한 효과를 가지게 된다*/
    public void Posts_등록된다() throws Exception {
        ...
        //when
        mvc.perform(post(url)  //mvc.perform: 생성된 MockMvc를 통해 API를 테스트한다. 본문 영역은 문자열 JSON으로 변환한다.
